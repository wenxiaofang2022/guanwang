<template>
  <div class="webglDomC" ref="webglDomC"></div>
</template>
...
export default {
  ...
  methods: {
    init () {
      // 初始化画布宽高
      const container = this.$refs.webglDomC;
    ...
    changeCamera(gltf){
      ...
      this.$refs.webglDomC.appendChild(renderer.domElement);
    ...
    loadModel(){
      ...
      const glburl = this.$store.state.sourcRoot+'/caseimg/03_new.glb';
