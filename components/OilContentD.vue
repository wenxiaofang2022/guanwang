<template>
  <div class="webglDomD" ref="webglDomD"></div>
</template>
...
export default {
  ...
  methods: {
    init () {
      // 初始化画布宽高
      const container = this.$refs.webglDomD;
    ...
    changeCamera(gltf){
      ...
      this.$refs.webglDomD.appendChild(renderer.domElement);
    ...
    loadModel(){
      ...
      const glburl = this.$store.state.sourcRoot+'/caseimg/04_new.glb';
